...
def sgd_optimization(dataset, learning_rate=0.13, n_epochs=1000,
    ...
    This is demonstrated on task 3 data.
    ...
    classifier = LogisticRegression(input=x, n_in=60*60, n_out=19)
        ...
        for minibatch_index in range(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    # save the best model
                    with open('./trained_models/best_model_T3.pkl', 'wb') as f:
        ...
        for minibatch_index in range(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    # save the best model
                    with open('./trained_models/best_model_MNIST.pkl', 'wb') as f:
                        pickle.dump(classifier, f)
...
def predict(X):
    ...
    classifier = pickle.load(open('./trained_models/best_model_T3.pkl'))
...
def predict_MNIST(X):
    ...
    # load the saved model
    classifier = pickle.load(open('./trained_models/best_model_MNIST.pkl'))
